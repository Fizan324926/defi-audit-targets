...
interface IReferralsUtils is IReferrals {
    ...
    /**
     * @dev Unsets referrer for specified traders
     * @param _traders array of trader addresses to unset referrers for
     */
    function unsetTradersReferrers(address[] calldata _traders) external;
    ...
    /**
     * @dev Emitted when a trader's referrer is unset
     * @param trader trader address
     * @param previousReferrer address of the referrer that was unset
     */
    event TraderReferrerUnset(address indexed trader, address indexed previousReferrer);
